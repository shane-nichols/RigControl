function [waveform, s1, s2] = galvoTriangleWave3(voltages1, voltages2, maxAccel, dt, rep_rate)
...
% Shane Nichols and Amanda Klaeger, 2019    
    ...
    s1 = [...
        ...
        zeros(1, 2*length(t) + length(voltages2))];
    
    s2 = [...
        zeros(1, length(t) + length(voltages1)), ...
